...
const Product = require("./databaseModels/product");
const Brand = require("./databaseModels/brand");
...
const uploadProduct = async (req, res) => {
  ...
  try {
    ...
    for (var i = 0; i < productInfoArray.length; i++) {
      S3UploadImg(`onlinemallroot/products/${savedProducts._id}`, productInfoArray[i].images);
    }
